export default {
  ...
  projectSupervisor: {
    ...
    logToStdout:
      'Bu süreç container’ın stdout’una yazıyor; supervisord bunu geri okuyamaz. Aşağıdaki, container’ın kendi çıktısı — tüm süreçler karışık.',
    pending:
    ...
    apply: 'Uygula',
    daemon: {
      button: 'supervisorctl',
      status: 'Durum',
      reread: 'Yapılandırmayı yeniden oku',
      update: 'Yapılandırma değişikliklerini uygula',
      'start-all': 'Tümünü başlat',
      'stop-all': 'Tümünü durdur',
      'restart-all': 'Tümünü yeniden başlat',
      silent: '(supervisorctl bir şey söylemedi)',
      confirm: {
        'stop-all': {
          title: 'Tüm süreçler durdurulsun mu?',
          message:
            'Bu php-fpm ve web sunucusunu da durdurur: bir şey yeniden başlatılana kadar {name} erişilemez olur.',
        },
        'restart-all': {
          title: 'Tüm süreçler yeniden başlatılsın mı?',
          message:
            'php-fpm ve web sunucusu da diğerleriyle birlikte yeniden başlar: {name} bir an için bağlantılarını düşürür.',
        },
      },
    },
    detail: {
      ...
      runtime: 'Şu an',
      declared: 'stackvo.json’da tanımlı',
      config: 'Container’daki yapılandırma',
      resources: 'Maliyet',
      ...
      pid: 'pid',
      uptime: 'Çalışma süresi',
      description: 'supervisord diyor ki',
      restarts: 'Görülen yeniden başlama',
      exec: 'Komut',
      replicas: 'Kopya',
      stopWait: 'Durdurma bekleme süresi',
      enabled: 'Etkin',
      yes: 'evet',
      no: 'hayır',
      memory: 'Bellek (RSS)',
      cpu: 'CPU, ömür boyu ortalama',
      cpuSeconds: 'CPU süresi',
      threads: 'Thread',
      noConfig: 'Container’daki yapılandırma dosyasında bu süreç için blok yok.',
      noResources: 'Ölçülecek bir şey yok — sürecin pid’i yok.',
      unknownHint:
        'Bu süreci ne imaj ne stackvo.json tanımlıyor. Container içinde eklenmiş; bir sonraki derleme onu düşürür — kalmasını istiyorsanız manifestteki `processes` bloğuna ekleyin.',
      origin: {
        image: 'imajdan',
        manifest: 'stackvo.json’dan',
        unknown: 'tanımsız',
      },
      signals: {
        HUP: 'Hang up — çoğu program yapılandırmasını yeniden okur ya da loglarını yeniden açar',
        INT: 'Interrupt — terminaldeki Ctrl+C ile aynı',
        QUIT: 'Quit — çık ve core dump bırak; nginx önce açık istekleri bitirir',
        USR1: 'Kullanıcı sinyali 1 — programa özgü; php-fpm ve nginx log dosyalarını yeniden açar',
        USR2: 'Kullanıcı sinyali 2 — programa özgü; php-fpm işçilerini nazikçe yeniler',
        TERM: 'Terminate — süreçten temiz çıkmasını ister; durdur’un gönderdiği sinyal',
        KILL: 'Kill — çekirdek anında sonlandırır; temizlik yok, hiçbir şey kaydedilmez',
      },
    },
  },
  supervisorCheck: {
